...
namespace EwingInventory
{
    ...
    public partial class Customer_Management : Form
    {
        ...
        public Customer_Management()
        {
            ...
            cmbsalesrep.Text = "";
            query = "SELECT fName FROM designation d,staff s WHERE name='Sales Representative' and d.id=s.desig;";
            ...
            while (reader.Read())
            {
                ...
                cmbsalesrep.Items.Add(reader[0].ToString());
            }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            String seller = cmbsalesrep.Text;
        ...
        private  void clearOrder()
        {
            ...
            //display delivery to in combo box
            string cid1 = txtcid1.Text;
            cmbdeliverto.Items.Clear();
            cmbdeliverto.Text = "";
            //display deliveryto in combo box
            query = "select showRoomLocation from deliverydetails where CID='" + cid1 + "'";
            cmd = new MySqlCommand(query, cnn);
        ...
        //   MessageBox.Show(contentValuei);
            ...
            else
            {
                ...
                while (reader1.Read())
                {
                    ...
                    txttotalDisc1.Text = (Convert.ToDouble(reader1[3].ToString()) + Convert.ToDouble(reader1[2].ToString()) + Convert.ToDouble(reader1[1].ToString())).ToString();
                    txtnetCost1.Text = reader1[5].ToString();
                    cmbsalesrep.Text = reader1[6].ToString();
                    txtdue.Text = reader1[12].ToString();
                    cmbdeliverto.SelectedText = reader1[8].ToString();
                    txttotqty1.Text = reader1[7].ToString();
                    expDelDate.Value = Convert.ToDateTime(reader1[9].ToString());
                ...
                if (reader1.HasRows)
                {
                    ...
                    else if ((qty <= (stock + additemstartqty)))
                    {
                        ...
                        if (confirm == DialogResult.Yes)
                        {
                            ...
                            itemtable.Refresh();
                            cnn.Open();
                            MySqlDataAdapter adp1 = new MySqlDataAdapter("select i.itemCode as ItemCode,i.Discription as Description,i.sellingPrice as WholesalePrice,i.MRP,o.qty as Qty,o.disc as Disc,o.totcost as TotalCost from item i,orderdetails o where i.itemCode=o.ItemNo and  invoiceNo='" + invoiceNo + "';", cnn);
                            adp1.Fill(dt2);
                            itemtable.DataSource = dt2;
                            //    itemtable.Columns[5].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
                            adp1.Dispose();
        ...
        private void txtcid3_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyValue == 13)
            {
                ...
                try
                {
                    ...
                    cnn.Open();
                    MySqlDataAdapter adp = new MySqlDataAdapter("select paymentid as PaymentID,date1 as PmtDate,sum(payingAmt) as AmountPaid  from payment where cid='" + cid + "' and PaymentID!='0' GROUP BY paymentid,date1;", cnn);
                    adp.Fill(dt5);
                    pmtIDtable.DataSource = dt5;
                    this.pmtIDtable.Columns[0].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
                    this.pmtIDtable.Columns[1].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (name!="" &&   address1 != "" && address2 != "" && email != "" )
            {
                ...
                else
                {
                    ...
                    cnn.Open();
                    query = "select * from customer where address1='"+ txtaddress1.Text + "' ;";
                    cmd = new MySqlCommand(query, cnn);
                    MySqlDataReader reader1 = cmd.ExecuteReader(); // query will be executed and data saved to the db
